...
1. **CHARACTER**
   ...
   - Scripture: 2 Peter 1:5b-8 (NLT) — "Supplement your faith with a generous provision of moral excellence, and moral excellence with knowledge, and knowledge with self-control, and self-control with patient endurance, and patient endurance with godliness, and godliness with brotherly affection, and brotherly affection with love for everyone."
...
3. **SERVICE**
   ...
   - Scripture: Philippians 2:3-7 (NIV) — "Do nothing out of selfish ambition or vain conceit. Rather, in humility value others above yourselves, not looking to your own interests but each of you to the interests of the others."

4. **FOR THE GLORY OF GOD**
   - Description: "Our desire is to honour and please God in every aspect of our lives, with a particular focus on character, excellence and service."
...
### External Form Links
- Performing Arts Sign-up: `https://forms.office.com/r/arRTyQYz9v`
- Sports Apparel Order: `https://forms.office.com/r/47hrLPdrHM`
- Music Lessons Registration: `https://forms.office.com/pages/responsepage.aspx?id=9SuBcUmkjEKokiT3wjTxBUuJLqDIJApFjBeg0M12_n9UNEFNSTJYVEhGTlVTSVFWT1I2RDY2UzRDNS4u&route=shorturl`
...
## 10. Page Content to Migrate

The following sections contain the actual text content from key pages that should be migrated to the new CMS. For brevity, only the most important pages are included here. Claude Code should fetch additional page content directly from the source URLs as needed during content migration.

### Principal's Welcome
**URL:** `/principals-welcome/`

Welcome content from Mr Gregg Le Roux introducing the school's mission and values.

### Special Character
**URL:** `/special-character/`

Middleton Grange School is a State Integrated Christian School. As a Christian school, the Bible is the foundation for all we do. We believe that education is fundamentally about preparing young people to live lives that honour God and serve others. Our Special Character permeates all aspects of school life.

### Vision & Mission Statement
**URL:** `/vision-mission-statement/`

**Vision:** To be a community of Christ-centered learners who are equipped and inspired to make a difference in the world.

**Mission:** To provide excellent education within a caring Christian community where students are encouraged to develop their God-given potential.

### Four Schools in One
**URL:** `/four-schools-in-one/`

Middleton Grange School is unique in offering education from Years 1-13 on one campus. The school is divided into four distinct divisions:

1. **Primary School (Years 1-6)** - Foundation learning in a nurturing environment
2. **Middle School (Years 7-10)** - Transition years with increasing independence
3. **Senior College (Years 11-13)** - NCEA qualifications and university preparation
4. **International College (Years 1-13)** - Supporting international students

### House Competition
**URL:** `/house-system/`

All students are placed into one of four Houses. The House system promotes healthy competition, school spirit, and leadership opportunities.

**Houses:**
- **Scott** - Named after Robert Falcon Scott, Antarctic explorer
- **Shackleton** - Named after Ernest Shackleton, Antarctic explorer
- **Wilson** - Named after Edward Wilson, Antarctic explorer and naturalist
- **Bowen** - Named after a major property owner in the area

---

## 11. Image Assets to Download

The following key images should be downloaded and stored in the new CMS:

### Logos
- Main Logo: `https://www.middleton.school.nz/wp-content/uploads/2019/11/cropped-Middleton-Grange-Logo_1300px-768x211.png`
- School Crest: `https://www.middleton.school.nz/wp-content/uploads/2021/05/Middleton-crest-logo.jpg`
- The Fridge Radio Logo: Various sizes available
- Music Academy Logo: `https://www.middleton.school.nz/wp-content/uploads/2019/11/MMA-Logo-w-side3.png`
- 60th Anniversary Logo: `https://www.middleton.school.nz/wp-content/uploads/2025/06/23169-60th-merch-logo-FA-01-300x298.png`

### Hero/Banner Images
- Homepage hero video: `https://www.middleton.school.nz/wp-content/uploads/2020/03/See-Us-In-Action.mp4`
- Primary School video: `https://www.middleton.school.nz/wp-content/uploads/siteassets/primary-school.mp4`
- Middle School video: `https://www.middleton.school.nz/wp-content/uploads/siteassets/middle-school-2.mp4`
- Senior College video: `https://www.middleton.school.nz/wp-content/uploads/siteassets/senior-college-2.mp4`

### Site Map
- Campus map: `https://www.middleton.school.nz/wp-content/uploads/2021/03/SitePlan1.png`

---

## 12. Notes for Content Migration

1. **Fetch page content dynamically** — Rather than including all 100+ pages of content in this document, Claude Code should fetch content from the live site as needed during migration.

2. **Preserve links** — When migrating content, ensure internal links are updated to the new URL structure, and external links are preserved.

3. **Download images** — Images embedded in page content should be downloaded and re-uploaded to Firebase Storage.

4. **Maintain hierarchy** — The menu structure and page relationships should be preserved exactly as documented.

5. **Special page types** — Pages with special templates (Video Gallery, Staff Listing, etc.) need their data structured appropriately in Firestore collections.

6. **External links** — Links to external services (KAMAR, KINDO, etc.) should remain as external links, not be migrated.

7. **PDFs** — PDF documents can either be re-uploaded to Firebase Storage or continue to link to the existing URLs (school's decision).
